...
class NextcloudTalkRichObject:
    ...
    def metadata(self) -> Dict[str, str]:
        ...
        return {
            k: v for k, v in self.__dict__.items() if k not in ["id", "object_type"]
        }
...
class DeckCard(NextcloudTalkRichObject):
    ...
    def __init__(
        self, id: str, name: str, board_name: str, stack_name: str, link: str
    ) -> None:
        super().__init__(id, name)
        self.link = link
...
class GeoLocation(NextcloudTalkRichObject):
    ...
    def __init__(self, id: str, name: str, latitude: str, longitude: str) -> None:
        super().__init__(id, name)
...
class SystemTag(NextcloudTalkRichObject):
    ...
    def __init__(self, id: str, name: str, visibility: str, assignable: str) -> None:
        super().__init__(id, name)
