...
class Participants(NextcloudModule):
    ...
    async def remove_from_conversation(self, room_token: str, attendee_id: int) -> None:
    ...
    async def join(
        ...
        response, _ = await self._post(
            ...
            data={"password": password, "force": force},
        )
        return response
    ...
    async def promote_to_moderator(self, room_token: str, attendee_id: int) -> None:
    ...
    async def demote(self, room_token: str, attendee_id: int) -> None:
    ...
    async def set_guest_display_name(self, room_token: str, name: str) -> None:
