...
class LoginFlowV2Api(NextcloudModule):
    ...
    async def wait_confirm(
        ...
        Args:
            token: The temporary token provided by login_flow_initiate()

            timeout: How long to wait for user authorization. Defaults to 60 seconds.
    ...
    async def destroy_token(self) -> None:
        ...
        You must currently be logged in using the app token.
