...
# @pytest.fixture
# def talk(nc: NextcloudClient) -> NextcloudTalkDriver:
#     return NextcloudTalkDriver(nc)


# @pytest.fixture
# def talk_app_token(nc_app_token: NextcloudClient) -> NextcloudTalkDriver:
#     return NextcloudTalkDriver(nc_app_token)
...
#         talk = NextcloudTalkDriver(magicmock)
#         assert talk.stub == "/ocs/v2.php"
#         assert talk.client == magicmock

#     def test_version(self, magicmock: MagicMock):
#         talk = NextcloudTalkDriver(magicmock, ocs_version="3")
#         assert talk.version == "3"
#         assert talk.stub == "/ocs/v3.php"

#     def test_stub(self, magicmock: MagicMock):
#         talk = NextcloudTalkDriver(magicmock, stub="/this/path/now")
#         assert talk.stub == "/this/path/now"


# @pytest.mark.asyncio
# class TestRequest:
#     async def test_default_get(self, talk: NextcloudTalkDriver, httpx_mock: HTTPXMock):
...
#         self, talk: NextcloudTalkDriver, httpx_mock: HTTPXMock
#     ):
...
#     async def test_has_talk_feature(
#         self, talk: NextcloudTalkDriver, httpx_mock: HTTPXMock
#     ):
