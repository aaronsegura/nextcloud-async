...
# @pytest.fixture
# def ocs(nc) -> NextcloudOcsDriver:
#     return NextcloudOcsDriver(nc)


# @pytest.fixture
# def ocs_app_token(nc_app_token) -> NextcloudOcsDriver:
#     return NextcloudOcsDriver(nc_app_token)
...
#         ocs = NextcloudOcsDriver(magicmock)
#         assert ocs.stub == "/ocs/v1.php"
#         assert ocs.client == magicmock

#     def test_version(self, magicmock):
#         ocs = NextcloudOcsDriver(magicmock, version="2")
#         assert ocs.version == "2"
#         assert ocs.stub == "/ocs/v2.php"

#     def test_stub(self, magicmock):
#         ocs = NextcloudOcsDriver(magicmock, stub="/this/path/now")
#         assert ocs.stub == "/this/path/now"


# @pytest.mark.asyncio
# class TestRequest:
#     async def test_default_get(self, ocs: NextcloudOcsDriver, httpx_mock: HTTPXMock):
...
#         self, ocs: NextcloudOcsDriver, httpx_mock: HTTPXMock
#     ):
...
#     async def test_raw_response(self, ocs: NextcloudOcsDriver, httpx_mock: HTTPXMock):
