...
# @pytest.fixture
# def dav(nc) -> NextcloudDavDriver:
#     return NextcloudDavDriver(nc)


# @pytest.fixture
# def dav_app_token(nc_app_token) -> NextcloudDavDriver:
#     return NextcloudDavDriver(nc_app_token)
...
#         dav = NextcloudDavDriver(magicmock)
#         assert dav.stub == "/remote.php/dav"
#         assert dav.client == magicmock
#         magicmock.assert_not_called()

#     def test_stub(self, magicmock):
#         dav = NextcloudDavDriver(magicmock, api_stub="/this/path/now")
#         assert dav.stub == "/this/path/now"


# @pytest.mark.asyncio
# class TestRequest:
#     async def test_default_get(self, dav: NextcloudDavDriver, httpx_mock: HTTPXMock):
...
#         self, dav: NextcloudDavDriver, httpx_mock: HTTPXMock
#     ):
...
#     async def test_raw_response(self, dav: NextcloudDavDriver, httpx_mock: HTTPXMock):
...
#     async def test_no_data(self, dav: NextcloudDavDriver, httpx_mock: HTTPXMock):
